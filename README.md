...
# Convex Convex Firebase Auth

[![npm version](https://badge.fury.io/js/@example%2Fconvex-firebase-auth.svg)](https://badge.fury.io/js/@example%2Fconvex-firebase-auth)
